    ...
    public void DbReadWrite()
    {
        ...
        try
        {
            ...
            TableSet ts = new TableSet(
                ...
                classes: new List<DbClass> { new(id: 1, parentType: 1, parentId: 1, fqn: string.Empty, accessFlags: 1, language: 1, isTestClass: 1) },
                methods: new List<DbMethod> {
                    new (id: 1, parentType: 1, parentId: 1, name: string.Empty, returnTypeId: 1, accessFlags: 1, language: 1, cyclomaticScore: 1), 
                    new (id: 2, parentType: 1, parentId: 1, name: string.Empty, returnTypeId: 1, accessFlags: 1, language: 1, cyclomaticScore: null) 
                },
                ...
                fields: new List<DbField>{new (id: 1, parentType:1, parentId:1, name:string.Empty, typeId:1, accessFlags:1, language:1)},
                ...
                sourceIndices: new List<DbSourceIndex>{new (elementId:1, fileId:1, type: string.Empty, startIdx: 1, endIdx: 1, startLine:1, startColumn:1, endLine:1, endColumn:1)}
            );
            // @formatter:on
            ...
            DiffTableSet dts = new DiffTableSet(
                ...
                classes: new List<DbDiffClass>{new(id: 1, parentType:1, parentId:1, parentIdDiff:1, fqn:string.Empty, accessFlags:1, headerSource:string.Empty, language:1,isTestClass:1, branchId:1 )},
                ...
                fields: new List<DbDiffField>{new(id: 1, parentType:1, parentId:1, parentIdDiff: 1, name:string.Empty, typeId:1, accessFlags:1, sourceCode:string.Empty, language:1, originalFieldId:1, branchId:1)},
                methodDeletes: new List<DbDiffMethodDeleted>{new(methodId:1, branchId:1)},
                methods: new List<DbDiffMethod>{new(id: 1, parentType:1, parentId:1, parentIdDiff: 1, name:string.Empty, accessFlags:1, sourceCode:string.Empty, language:1, branchId:1, returnTypeId:1, originalMethodId: 1, fieldId:"1")},
