    ...
    public void DbReadWrite()
    {
        ...
        try
        {
            ...
            TableSet ts = new TableSet(
                ...
                classes: new List<DbClass> { new(id: 1, parentClassId: 1, parentFileId: 1, fqn: string.Empty, accessFlags: 1, language: 1, isTestClass: 1) },
                methods: new List<DbMethod> {
                    new (id: 1, parentClassId: 1, parentFileId: 1, name: string.Empty, returnTypeId: 1, accessFlags: 1, language: 1, cyclomaticScore: 1), 
                    new (id: 2, parentClassId: 1, parentFileId: 1, name: string.Empty, returnTypeId: 1, accessFlags: 1, language: 1, cyclomaticScore: null) 
                },
            ...
            DiffTableSet dts = new DiffTableSet(
                ...
                classes: new List<DbDiffClass>{new(id: 1, parentClassId:1, parentFileId:1, parentClassIdDiff:1, parentFileIdDiff:1, fqn:string.Empty, accessFlags:1, headerSource:string.Empty, language:1,isTestClass:1, branchId:1 )},
                ...
                fields: new List<DbDiffField>{new(id: 1, parentClassId:1, parentFileId:1, parentClassIdDiff: 1,parentFileIdDiff:1, name:string.Empty, typeId:1, accessFlags:1, sourceCode:string.Empty, language:1, originalFieldId:1, branchId:1)},
                methodDeletes: new List<DbDiffMethodDeleted>{new(methodId:1, branchId:1)},
                methods: new List<DbDiffMethod>{new(id: 1, parentClassId:1, parentFileId:1, parentClassIdDiff: 1,parentFileIdDiff:1, name:string.Empty, accessFlags:1, sourceCode:string.Empty, language:1, branchId:1, returnTypeId:1, originalMethodId: 1, fieldId:"1")},
